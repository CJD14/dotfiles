" Vim color file not_distracting
...
set t_Co=256
let colors_name = "not_distracting"

hi Comment	    guifg=#75715e    ctermfg=242    gui=bold    cterm=bold 
hi Constant	    guifg=#f8f8f2    ctermfg=196    gui=none    cterm=none 
...
hi Function	    guifg=#f8f8f2    ctermfg=196    gui=none    cterm=none 
hi Identifier	    guifg=#f8f8f2    ctermfg=196    gui=none    cterm=none 
...
hi Statement	    guifg=#f8f8f2    ctermfg=196    gui=bold    cterm=bold 
...
hi String	    guifg=#f8f8f2    ctermfg=196    gui=none    cterm=none 
hi StorageClass	    guifg=#f8f8f2    ctermfg=196    gui=none    cterm=none 
hi Title	    guifg=#cd5c5c    ctermfg=252    gui=bold    cterm=bold 
hi Todo	    guifg=#fffefc    ctermfg=226    gui=none    cterm=none 
hi Type	    guifg=#f8f8f2    ctermfg=196    gui=none    cterm=none 
