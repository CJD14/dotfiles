...
set t_Co=256
let colors_name = "monokartes"

hi Comment	    guifg=#f8f8f2    ctermfg=196    gui=bold    cterm=bold 
...
hi NonText	    guibg=#333333    ctermbg=237    guifg=#66d8ef    ctermfg=242    gui=none    cterm=none 
...
hi Title	    guifg=#f8f8f2    ctermfg=196    gui=bold    cterm=bold 
hi Todo	    guifg=#fffefc    ctermfg=226    gui=none    cterm=none 
hi Type	    guifg=#a7e229    ctermfg=248    gui=none    cterm=none 
hi Underlined	    guifg=#f8f8f2    ctermfg=196    gui=underline    cterm=underline 
